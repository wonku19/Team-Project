-- 외래키 초기화
ALTER TABLE AUCTION_BOARD DROP CONSTRAINT FK_AUCTION_MAIN_CATEGORY;
ALTER TABLE AUCTION_BOARD DROP CONSTRAINT FK_AUCTION_CATEGORY;
ALTER TABLE AUCTION_BOARD DROP CONSTRAINT FK_AUCTION_MEMBER;
ALTER TABLE MAIN_CATEGORY DROP CONSTRAINT FK_MAIN_CATEGORY_AUCTION;
ALTER TABLE CATEGORY DROP CONSTRAINT FK_CATEGORY_AUCTION;
ALTER TABLE CATEGORY DROP CONSTRAINT FK_CATEGORY_MAIN_CATEGORY;
...
DROP SEQUENCE SEQ_MAIN_CATEGORY;
...
CREATE TABLE AUCTION_BOARD (
    ...
    CATEGORY_NO NUMBER, -- 메인카테고리 외래키
    CATEGORY_SUB_NO NUMBER, -- 서브카테고리 외래키
...
CREATE TABLE CATEGORY (
    CATEGORY_SUB_NO NUMBER PRIMARY KEY, -- 카테고리 번호
...
-- 외래키 설정
-- 경매게시판 (메인카테고리, 서브카테고리, 회원)
ALTER TABLE AUCTION_BOARD ADD CONSTRAINT FK_AUCTION_MAIN_CATEGORY FOREIGN KEY(CATEGORY_NO) REFERENCES MAIN_CATEGORY;
ALTER TABLE AUCTION_BOARD ADD CONSTRAINT FK_AUCTION_CATEGORY FOREIGN KEY (CATEGORY_SUB_NO) REFERENCES CATEGORY;
ALTER TABLE AUCTION_BOARD ADD CONSTRAINT FK_AUCTION_MEMBER FOREIGN KEY (MEMBER_ID) REFERENCES MEMBER;
-- 메인카테고리 (경매게시판)
ALTER TABLE MAIN_CATEGORY ADD CONSTRAINT FK_MAIN_CATEGORY_AUCTION FOREIGN KEY (AUCTION_NO) REFERENCES AUCTION_BOARD;
-- 서브카테고리 (경매게시판, 메인카테고리)
ALTER TABLE CATEGORY ADD CONSTRAINT FK_CATEGORY_AUCTION FOREIGN KEY (AUCTION_NO) REFERENCES AUCTION_BOARD;
ALTER TABLE CATEGORY ADD CONSTRAINT FK_CATEGORY_MAIN_CATEGORY FOREIGN KEY (CATEGORY_NO) REFERENCES MAIN_CATEGORY;
-- 배송 (경매게시판, 회원)
